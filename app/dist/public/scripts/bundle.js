...
var SignInForm = function SignInForm(_ref) {
  ...
  function handleSubmit(data) {
    if (!auth.user) {
      return signIn(data).catch(function (err) {
        return console.log(err);
      }).then(_reactRouter.browserHistory.push('/admin')).then(loadAuth);
    }
...
var formFactory = function formFactory(_ref) {
  ...
  var Form = function Form(_ref2) {
    ...
    var renderInput = function renderInput(field, type, label) {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'span',
            { className: field.dirty ? 'hasvalue' : '' },
            label
          ),
    ...
    return _react2.default.createElement(
      'form',
      { className: styleClass, onSubmit: handleSubmit },
